...
const accordionData: AccordionItem[] = [
  {
    id: 1,
    title: "Memahami Konsep Ekosistem",
    description:
      "Mengidentifikasi lingkungan biotik dan abiotik serta interaksi yang terjadi di dalamnya.",
  },
  {
    id: 2,
    title: "Menganalisis Perubahan Lingkungan",
    description:
      "Memahami dampak perubahan lingkungan (baik faktor alami maupun aktivitas manusia) terhadap kelangsungan hidup organisme.",
  },
  {
    id: 3,
    title: "Mengintegrasikan Kearifan Lokal",
    description:
      "Mengaplikasikan nilai budaya Sunda (Pancaniti) dalam upaya pelestarian lingkungan dan konservasi sumber daya alam.",
  },
];

export default function TujuanPembelajaranPage() {
  const [isSidebarOpen, setIsSidebarOpen] = useState(false);
  // Default state: all 3 items open as shown in visual reference
    ...
    <main className="min-h-screen w-full bg-[#EDF0E8] flex flex-col items-center px-6 pt-4 pb-8 relative overflow-x-hidden font-sans">
      ...
      <div className="w-full max-w-[354px] flex flex-col items-center gap-6 z-10 flex-1">
        ...
        <div className="relative w-full h-[140px] rounded-[24px] overflow-hidden p-6 flex items-center shadow-md">
          ...
          <Image
            src="/gambar 2.png"
            alt="Latar Belakang Tujuan Pembelajaran"
            fill
            priority
            unoptimized={true}
