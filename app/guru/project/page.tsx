                ...
                >
                  ...
                  <div className="w-[153px] flex-shrink-0 relative" data-status-dropdown>
                    <button
                      ...
                      className={`w-[153px] h-[48px] rounded-[12px] px-[16px] py-[12px] flex items-center justify-between gap-[12px] cursor-pointer transition-colors shadow-sm hover:opacity-95 ${statusStyle.bg} ${statusStyle.text}`}
                    >
